...
<body>
	...
	<div class="container p-0">
		<main>
			<form action="${cp}/board/write" id="writeForm" method="post">
				<div class="small border-bottom border-3 border-black p-0 pb-2">
					<a href="#">
						<div>
							<span class="text-primary">전체</span> 카테고리
						</div>
					</a>
				</div>

				<div class="small p-0 py-2 align-items-center">
					<input placeholder="제목" class="form-control" name="title"
						id="title">
				</div>
				<div
					class="pt-1 pb-2 p-0 py-5 ps-1 small border-bottom border-1 border-muted">
				...
				<div class="d-grid my-2 attach-area">
					...
					<label class="btn btn-info">파일 첨부<input type="file"
						multiple class="d-none" id="f1"></label>
				...
				<div class="my-2">
					<button class="btn btn-secondary btn-sm" type="button">목록</button>
					<div class="float-end">
						<button type="submit" class="btn btn-outline-primary btn-sm">
							<i class="fa-solid fa-pen-fancy"></i> 글쓰기
						</button>
						<button type="button" class="btn btn-outline-primary btn-sm">
							<i class="fa-solid fa-clipboard"></i> 스크랩
						</button>
					</div>
				</div>
